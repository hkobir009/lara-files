...
class OTPVerificationController extends Controller
{
    ...
    public function verify_phone(Request $request){
        ...
        if ($user->verification_code == $request->verification_code) {
            ...
            $user->resent_verification_expires_at = null;
            $user->save();
    ...
    public function resend_verificcation_code(Request $request){
        ...
        $user->resent_verification_expires_at = now()->addMinutes(2);
        $user->save();
    ...
    {
        return view('otp_systems.frontend.auth.passwords.reset_with_phone')->with('email', $request->email);
    }

...
class HomeController extends Controller
{
    ...
    public function index()
    {
        $featured_categories = Cache::rememberForever('featured_categories', function () {
            return Category::with('childrenCategories')->where('featured', 1)->get();
        });

        // $featured_categories_subcategories = Cache::rememberForever('featured_categories_subcategories', function () use ($featured_categories) {
        //     return Category::whereIn('parent_id', $featured_categories->pluck('id'))->get();
        // });
    ...
    public function faq(){
        $faqs =  Faq::all();
        return view("frontend.policies.faq",compact('faqs'));
    }

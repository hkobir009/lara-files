                ...
                <tbody>
                    @foreach ($products as $key => $product)
                        <tr>
                            ...
                            <td class="text-right">
                                <a href="{{route('seller.digitalproducts.edit',  ['id'=>$product->id, 'lang'=>config('custom.default_language')] )}}" class="btn btn-soft-info btn-icon btn-circle btn-sm" title="{{ translate('Edit') }}">

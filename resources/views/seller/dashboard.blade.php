...
@section('panel_content')
    <div class="aiz-titlebar mt-2 mb-4">
        <div class="row align-items-center">
            <div class="col-md-6">
                <h1 class="h3 text-dark">{{ translate('Dashboard') }}</h1>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-sm-6 col-md-6 col-xxl-3">
            <div class="card shadow-none mb-4 bg-grad-1 py-4">
                <div class="card-body">
                    <div class="row align-items-center">
                        <div class="col">
                        ...
                        <div class="col-auto text-right">
                            <svg xmlns="http://www.w3.org/2000/svg" width="64.001" height="64" viewBox="0 0 64.001 64">
                                <path id="Path_66" data-name="Path 66"
                                    ...
                                    transform="translate(-84.944 -106.382)" fill="#060c17" />
                            </svg>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-sm-6 col-md-6 col-xxl-3">
            <div class="card shadow-none mb-4 bg-grad-2 py-4">
                <div class="card-body">
                    <div class="row align-items-center">
                        <div class="col">
                            <p class="small text-muted mb-0">
                        ...
                        <div class="col-auto text-right">
                            <svg xmlns="http://www.w3.org/2000/svg" width="64" height="61.143" viewBox="0 0 64 61.143">
                                <path id="Path_57" data-name="Path 57"
                                    ...
                                    transform="translate(0 0)" fill="#060c17" />
                            </svg>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-sm-6 col-md-6 col-xxl-3">
            <div class="card shadow-none mb-4 bg-grad-3 py-4">
                <div class="card-body">
                    <div class="row align-items-center">
                        <div class="col">
                            <p class="small text-muted mb-0">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="64" height="64" viewBox="0 0 64 64">
                                <g id="Group_25" data-name="Group 25" transform="translate(-1561.844 1020.618)">
                                    <path id="Path_58" data-name="Path 58"
                                        ...
                                        transform="translate(1370.615 -1127)" fill="#060c17" />
                                    <path id="Path_59" data-name="Path 59"
                                        d="M213.73,117.882h24a1,1,0,0,1,0,2h-24a1,1,0,0,1,0-2"
                                        transform="translate(1372.115 -1115.5)" fill="#060c17" />
                                    <path id="Path_60" data-name="Path 60" d="M210.23,117.382a2,2,0,1,0,2,2,2,2,0,0,0-2-2"
                                        transform="translate(1367.615 -1116)" fill="#060c17" />
                                    ...
                                    <path id="Path_65" data-name="Path 65"
                                        ...
                                        transform="translate(1360.615 -1125)" fill="#060c17" />
                                </g>
                            </svg>
                        </div>
                    </div>
        ...
        <div class="col-sm-6 col-md-6 col-xxl-3">
            <div class="card shadow-none mb-4 bg-grad-4 py-4">
                <div class="card-body">
                    <div class="row align-items-center">
                        <div class="col">
                            <p class="small text-muted mb-0">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="64" height="64.001" viewBox="0 0 64 64.001">
                                <g id="Group_26" data-name="Group 26" transform="translate(-1571.385 1123.29)">
                                    ...
                                    <path id="Path_67" data-name="Path 67"
                                        ...
                                        transform="translate(1360.615 -1127)" fill="#060c17" />
                                    ...
                                    <path id="Path_68" data-name="Path 68"
                                        ...
                                        transform="translate(1367.074 -1120.976)" fill="#060c17" />
                                </g>
                            </svg>
                        </div>
                    </div>
    ...
    <div class="row">
        <div class="col-sm-6 col-md-6 col-lg-3 mb-4">
            <div class="card shadow-none">
                <div class="card-body">
                    <div class="card-title text-dark fs-16 fw-600">
            ...
            <div class="card shadow-none mb-0">
                ...
                <div class="card-body">
                    ...
                    <p class="text-dark">
                        {{ translate('Your Sold Amount (Current month)') }}</p>
                    <h3 class="text-dark fw-600 fs-30">
                    ...
                    <ul class="list-group">
                        @foreach (\App\Models\Category::all() as $key => $category)
                            @if (count($category->products->where('user_id', Auth::user()->id)) > 0)
                                <li class="d-flex justify-content-between align-items-center my-2 text-dark fs-13">
                ...
                <div class="card-body">
                    ...
                    <div class="row align-items-center mb-4">
                                ...
                                <g id="Group_23742" data-name="Group 23742" transform="translate(2044 3467)">
                                    ...
                                    <g id="Group_23741" data-name="Group 23741" transform="translate(310 759)">
                                        <path id="Path_26908" data-name="Path 26908"
                                            ...
                                            transform="translate(-2351 -4226)" fill="060c17" />
                                        <path id="Path_26909" data-name="Path 26909"
                                            ...
                                            transform="translate(-2491.298 -4498.774)" fill="060c17" />
                                    </g>
                                </g>
                            </svg>
                        </div>
                        <div class="col">
                            <p class="small text-muted mb-0">
                                <span class="fe fe-arrow-down fe-12"></span>
                                <span class="fs-13 text-dark fw-600">{{ translate('New Order') }}</span>
                            </p>
                    ...
                    <div class="row align-items-center mb-4">
                                ...
                                <g id="Group_23751" data-name="Group 23751" transform="translate(0 0.001)">
                                    <g id="Group_23750" data-name="Group 23750" transform="translate(0 -0.001)"
                                        ...
                                        <path id="Path_27506" data-name="Path 27506"
                                            ...
                                            transform="translate(-174.22 -84.719)" fill="060c17" />
                                        <path id="Path_27507" data-name="Path 27507"
                                            ...
                                            transform="translate(-227.869 -227.867)" fill="060c17" />
                                        <path id="Path_27508" data-name="Path 27508"
                                            ...
                                            transform="translate(-307.867 -307.756)" fill="060c17" />
                                    </g>
                                </g>
                            </svg>
                        </div>
                        <div class="col">
                            <p class="small text-muted mb-0">
                                <span class="fe fe-arrow-down fe-12"></span>
                                <span class="fs-13 text-dark fw-600">{{ translate('Cancelled') }}</span>
                            </p>
                            <h3 class="mb-0 text-dark">
                    ...
                    <div class="row align-items-center mb-4">
                                ...
                                <g id="Group_23745" data-name="Group 23745" transform="translate(1901 3455)">
                                    ...
                                    <g id="Group_23744" data-name="Group 23744" transform="translate(-867.487 654.098)">
                                        ...
                                        <path id="Path_26914" data-name="Path 26914"
                                            ...
                                            transform="translate(-2536.278 -4319.726)" fill="060c17" />
                                        <path id="Path_26915" data-name="Path 26915"
                                            ...
                                            transform="translate(-2493.036 -4255.966)" fill="060c17" />
                        ...
                        <div class="col">
                            <p class="small text-muted mb-0">
                                <span class="fe fe-arrow-down fe-12"></span>
                                <span class="fs-13 text-dark fw-600">{{ translate('On Delivery') }}</span>
                            </p>
                            <h3 class="mb-0 text-dark">
                    ...
                    <div class="row align-items-center mb-4">
                                ...
                                <g id="Group_23747" data-name="Group 23747" transform="translate(1894 3457)">
                                    ...
                                    <g id="Group_23746" data-name="Group 23746" transform="translate(-1599.983 686.845)">
                                        ...
                                        <path id="Path_26919" data-name="Path 26919"
                                            ...
                                            transform="translate(-2557.593 -4432.681)" fill="060c17" />
                                        <path id="Path_26920" data-name="Path 26920"
                                            ...
                                            transform="translate(-2626.31 -4518.65)" fill="060c17" />
                                    </g>
                                </g>
                            </svg>
                        </div>
                        <div class="col">
                            <p class="small text-muted mb-0">
                                <span class="fe fe-arrow-down fe-12"></span>
                                <span class="fs-13 text-dark fw-600">{{ translate('Delivered') }}</span>
                            </p>
                            <h3 class="mb-0 text-dark">
                                {{ \App\Models\OrderDetail::where('seller_id', Auth::user()->id)->where('delivery_status', 'delivered')->count() }}
                            </h3>
    ...
    <div class="row">
        <div class="col-sm-6 col-md-6 col-lg-3">
            <a href="{{ route('seller.money_withdraw_requests.index') }}"
                class="card mb-4 p-4 text-center h-180px">
                ...
                <div class="m-3">
                    <svg id="Group_22725" data-name="Group 22725" xmlns="http://www.w3.org/2000/svg" width="48" height="48"
                        ...
                        <path id="Path_110"
                            ...
                            fill="060c17" />
                        <path id="Path_111" d="M28.5,21h-9a4.5,4.5,0,0,0,9,0" fill="060c17" />
                    </svg>
                </div>
            </a>
        </div>
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48">
                        <g id="Group_22724" data-name="Group 22724" transform="translate(-1284 -875)">
                            <rect id="Rectangle_17080" data-name="Rectangle 17080" width="2" height="48" rx="1"
                                transform="translate(1307 875)" fill="060c17" />
                            <rect id="Rectangle_17081" data-name="Rectangle 17081" width="2" height="48" rx="1"
                                transform="translate(1332 898) rotate(90)" fill="060c17" />
                        </g>
                    </svg>
                </div>
            </a>
                ...
                <div class=" m-3">
                    <svg id="Group_30" data-name="Group 30" xmlns="http://www.w3.org/2000/svg" width="31.999" height="32"
                        ...
                        <path id="Path_83" data-name="Path 83"
                            ...
                            transform="translate(-92.946 -10)" fill="060c17" />

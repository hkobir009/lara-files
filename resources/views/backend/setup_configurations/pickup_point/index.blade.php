            ...
            <tbody>
                @foreach($pickup_points as $key => $pickup_point)
                    <tr>
						...
						<td class="text-right">
							<a class="btn btn-soft-primary btn-icon btn-circle btn-sm" href="{{route('pick_up_points.edit', ['id'=>$pickup_point->id, 'lang'=>config('custom.default_language')] )}}" title="{{ translate('Edit') }}">

            ...
            <div class="row gutters-5 mb-5">
                ...
                <div class="col-md-3">
                    ...
                    <select class="form-control aiz-selectpicker" data-minimum-results-for-search="Infinity"
                            id="update_payment_status" name="update_payment_status">
                        <option value="unpaid"
                ...
                <div class="col-md-3">
                    <label>@lang('Update Payment Status')</label>
                    <button id="update_payment_status_button" class="btn btn-primary form-control" type="submit">@lang('Update')</button>
                </div>
                <div class="col-md-3">
                    <label for="update_delivery_status">{{translate('Delivery Status')}}</label>
                    @if($delivery_status != 'delivered' && $delivery_status != 'cancelled')
                        <select class="form-control aiz-selectpicker" data-minimum-results-for-search="Infinity"
                                id="update_delivery_status" name="update_delivery_status">
                ...
                <div class="col-md-3">
                    <label>@lang('Update Delivery Status')</label>
                    <button id="update_delivery_status_button" class="btn btn-primary form-control" type="submit">@lang('Update')</button>
                </div>
                <div class="col-md-3">
                    <label for="update_tracking_code">{{translate('Tracking Code (optional)')}}</label>
                    <input type="text" class="form-control" id="update_tracking_code" name="update_tracking_code"
                           value="{{ $order->tracking_code }}">
                </div>
                <div class="col-md-3">
                    <label>@lang('Update Tracking Code')</label>
                    <button id="update_tracking_code_button" class="btn btn-primary form-control" type="submit">@lang('Update')</button>
                </div>
            </div>
            <div class="mb-3">
                @php
...
@section('script')
    <script type="text/javascript">
        ...
        $('#update_delivery_status_button').on('click', function () {
            ...
            $.post('{{ route('orders.update_delivery_status') }}', {
                ...
                $('#update_delivery_status_button').prop('disabled', false);
            });
        });

        $('#update_payment_status_button').on('click', function () {
            $(this).prop('disabled', true);
            var order_id = {{ $order->id }};
            ...
            $.post('{{ route('orders.update_payment_status') }}', {
                ...
                $('#update_payment_status_button').prop('disabled', false);
            });
        });

        $('#update_tracking_code_button').on('click', function () {
            $(this).prop('disabled', true);
            var order_id = {{ $order->id }};
            ...
            $.post('{{ route('orders.update_tracking_code') }}', {
                ...
                $('#update_tracking_code_button').prop('disabled', false);
            });
        });
    </script>
@endsection

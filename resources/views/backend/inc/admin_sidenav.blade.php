                ...
                @if(Auth::user()->user_type == 'admin' || in_array('10', json_decode(Auth::user()->staff->role->permissions)))
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('pre_order.admin_index') }}" class="aiz-side-nav-link">
                                    <span class="aiz-side-nav-text">{{ translate('Pre Order History') }}</span>
                                </a>
                            </li>
                        </ul>
                    </li>
                ...
                @if(Auth::user()->user_type == 'admin' || in_array('13', json_decode(Auth::user()->staff->role->permissions)))
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('website.faq.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['website.faq.index', 'website.faq.create','website.faq.edit'])}}">

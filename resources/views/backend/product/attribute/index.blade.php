						...
						@foreach($attributes as $key => $attribute)
							<tr>
								...
								<td class="text-right">
									...
									<a class="btn btn-soft-primary btn-icon btn-circle btn-sm" href="{{route('attributes.edit', ['id'=>$attribute->id, 'lang'=>config('custom.default_language')] )}}" title="{{ translate('Edit') }}">

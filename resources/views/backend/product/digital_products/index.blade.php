                ...
                <tbody>
                    @foreach($products as $key => $product)
                        <tr>
                            ...
                            <td class="text-right">
                                <a class="btn btn-soft-primary btn-icon btn-circle btn-sm" href="{{route('digitalproducts.edit', ['id'=>$product->id, 'lang'=>config('custom.default_language')] )}}" title="{{ translate('Edit') }}">

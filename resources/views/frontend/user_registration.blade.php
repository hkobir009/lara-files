                                ...
                                <div class="">
                                    <form id="reg-form" class="form-default" role="form"
                                        ...
                                        <div class="form-group">
                                            <input type="text"
                                                   class="form-control rounded-pill{{ $errors->has('name') ? ' is-invalid' : '' }}"
                                        ...
                                        @if (addon_is_activated('otp_system'))
                                            <div class="form-group phone-form-group mb-1">
                                                <input type="text" id="phone-code"
                                                       class="form-control rounded-pill{{ $errors->has('phone') ? ' is-invalid' : '' }}"
                                        ...
                                        <div class="mb-3">
                                            <label class="aiz-checkbox">
                                                ...
                                                <span
                                                    class=opacity-60>{{ translate('By signing up you agree to our')}}</span>
                                                <a class="py-1 text-underline text-dark opacity-60"
                                                   href="{{route('terms')}}">
                                                    Terms & Conditions</a> or
                                                <a class="py-1 text-underline text-dark opacity-60"
                                        ...
                                        <div class="mb-5">
                                            <button type="submit"
                                                    class="btn btn-primary btn-block fw-600 rounded-pill">{{  translate('Create Account') }}</button>
                                        </div>
                                    </form>

...
<body>
    ...
    <div class="aiz-main-wrapper d-flex flex-column">
        <div class="bg-light bs-canvas bs-canvas-left h-100 position-fixed">
    ...
    <script>
        ...
        function show_purchase_history_details(orderId) {
            window.location.replace("{{ url('/purchase_history/details/') }}" + "/" + orderId);
        }
        ...
        $(".xzoom, .xzoom-gallery").xzoom({ xzoomWidth: 500, tint: '#333', Xoffset: 15 });
    </script>

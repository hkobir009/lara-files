...
@section('content')
    ...
    <div class="home-banner-area mb-4">
        {{-- static slider start here --}}  
        {{-- <div class="home-slider">
            <div class="carousel-box" style="width: 100%; display: inline-block;">
                <a href="#" class="text-reset d-block" tabindex="-1">
                    <img class="rounded-0 w-100"
                        src="https://storage.googleapis.com/monarchmart-storage/uploads/all/7ghUt9nDPOnihM3kcBOhZoPYpxrBKrldrxsoHLNO.jpg"
                        class="img-fit">
                </a>
            </div>
            <div class="carousel-box" style="width: 100%; display: inline-block;">
                <a href="#" class="text-reset d-block" tabindex="-1">
                    <img class="rounded-0 w-100"
                        src="https://storage.googleapis.com/monarchmart-storage/uploads/all/yaG91CcA9JPMnz7OigiucImq1jUgD9lpZBHLAha1.jpg"
                        class="img-fit">
                </a>
            </div>
            <div class="carousel-box" style="width: 100%; display: inline-block;">
                <a href="#" class="text-reset d-block" tabindex="0">
                    <img class="rounded-0 w-100"
                        src="https://storage.googleapis.com/monarchmart-storage/uploads/all/FQA5sgbDpEz5vYyqiHWIQtGT8c9DaYY7cfTANOBF.png"
                        class="img-fit">
                </a>
            </div>
            <div class="carousel-box" style="width: 100%; display: inline-block;">
                <a href="#" class="text-reset d-block" tabindex="-1">
                    <img class="rounded-0 w-100"
                        src="https://storage.googleapis.com/monarchmart-storage/uploads/all/7634v0IYahuY9FiPmD8ozRGPZkZm1Jgkj8QPf9MD.jpg"
                        class="img-fit">
                </a>
            </div>
        </div> --}}
        {{-- <ul class="slick-dots list-unstyled d-flex" role="tablist" style="">
            ...
            <li role="presentation" class="slick-active"><button type="button" role="tab" id="slick-slide-control03"
                    aria-controls="slick-slide03" aria-label="4 of 5" tabindex="0" aria-selected="true">4</button></li>
            <li role="presentation" class=""><button type="button" role="tab" id="slick-slide-control04"
                            ...
                            @foreach ($slider_images as $key => $value)
                                <div class="carousel-box">
                                    <a href="{{ json_decode(get_setting('home_slider_links'), true)[$key] }}">
                                        <img class="d-block w-100 img-fit shadow-sm overflow-hidden"
        ...
        {{-- static category section design --}}

        <div class="bg-soft-primary py-5 text-center">
            <div class="container">
                <div class="text-center">
                    <h6 class="text-primary fs-24">Categories</h6>
                    <div class="mb-5 fs-16 fw-300 opacity-60">Get Your Product from Category</div>
                </div>
                            ...
                            <div class="mb-lg-0">
                                <a href="{{ json_decode(get_setting('home_banner1_links'), true)[$key] }}"
                                    ...
                                    <img src="{{ asset('assets/img/placeholder-rect.jpg') }}"
                                        ...
                                        alt="{{ env('APP_NAME') }} promo" class="img-fit img-fluid lazyload w-100">
                                </a>
                            </div>
                        </div>
                    @endforeach
    ...
    @endif
        <div class="new-devider bg-light py-4">
            <div class="container">
                <div class="row">
                    <div class="col-md-4 text-center">
                        <div class="shake-divider d-inline-block">
                          <div class="c-pointer d-flex flex-column align-items-center">
                            <i class="las la-shuttle-van la-2x text-primary my-2"></i>
                            <h6 class="mb-0 text-primary">100% Authentic Brands</h6>
                          </div>
                        </div>
                    </div>
                    <div class="col-md-4 text-center">
                        <div class="shake-divider d-inline-block">
                            <div class="c-pointer d-flex flex-column align-items-center mt-3 mt-md-0">
                                <i class="las la-clock la-2x text-capitalize text-primary my-2"></i>
                                <h6 class="mb-0 text-capitalize text-primary">24/7 customer support</h6>
                            </div>
                        </div>
                    </div>
                   <div class="col-md-4 text-center">
                     <div class="shake-divider d-inline-block">
                        <div class="c-pointer d-flex flex-column align-items-center mt-3 mt-md-0">
                            <i class="las la-clock la-2x text-capitalize text-primary my-2"></i>
                            <h6 class="mb-0 text-capitalize text-primary">Top quality</h6>
                        </div>
                     </div>
                   </div>
                </div>

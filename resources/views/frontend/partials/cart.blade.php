...
@endphp
<a href="{{ route('cart') }}"
    class="ml-3 position-relative size-45px bg-light d-flex align-items-center justify-content-center rounded-10 cart-toggler cart-trigger rounded-circle">
    <i class="las la-shopping-cart la-2x opacity-80"></i>

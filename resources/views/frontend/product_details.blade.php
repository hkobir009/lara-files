    ...
    <section class="mb-4 pt-3">
        <div class="container">
            <div class="bg-white shadow-sm rounded p-3">
                <div class="row">
                    <div class="col-xl-5 col-lg-6 mb-4 xzoom-container">
                        <div class="sticky-top z-3 row gutters-10">
                            @php
                                $photos = explode(',', $detailedProduct->photos);
                            @endphp
                            <div class="col order-1 position-relative order-md-2">
                                <div class="aiz-carousel product-gallery" data-nav-for='.product-gallery-thumb' data-fade='true' data-auto-height='true'>
                                    @foreach ($photos as $key => $photo)
                                        <div class="carousel-box rounded">
                                            <img class="img-fluid lazyload xzoom h-100 mx-auto"
                                                src="{{ asset('assets/img/placeholder.jpg') }}"
                                                xoriginal="{{ uploaded_asset($photo) }}"
                            ...
                            <div class="col-12 col-md-auto w-md-80px order-2 order-md-1 mt-3 mt-md-0">
                                <div class="aiz-carousel product-gallery-thumb" data-items='5' data-nav-for='.product-gallery' data-vertical='true' data-vertical-sm='false' data-focus-select='true' data-arrows='true'>
                                    <div class="carousel-box c-pointer border pt-2 p-md-1 rounded xzoom-thumbs d-flex justify-content-center flex-md-column flex-row">
                                        @foreach ($photos as $key => $photo)
                                        <a class="mx-1 mx-md-0" href="{{ uploaded_asset($photo) }}">
                                            <img
                                            class="lazyload mw-100 size-50px mx-auto xzoom-gallery"
                                            src="{{ asset('assets/img/placeholder.jpg') }}"
                                            data-src="{{ uploaded_asset($photo) }}"
                                            onerror="this.onerror=null;this.src='{{ asset('assets/img/placeholder.jpg') }}';">
                                        </a>
                    ...
                    <div class="col-xl-7 col-lg-6 positon-relative mb-4">
                        <div class="text-left">
                                            ...
                                            <div class="aiz-radio-inline">
                                                ...
                                                <label class="aiz-megabox pl-0 mr-2" data-toggle="tooltip" data-title="{{ \App\Models\Color::where('code', $color)->first()->name }}">
                                                    <input
                                                        ...
                                                        @if($key == 0) checked @endif
                                                    >
                                                    <span class="aiz-megabox-elem rounded d-flex align-items-center justify-content-center p-1 mb-2 rounded-circle">
                                                        <span class="size-30px d-inline-block rounded-circle" style="background: {{ $color }};"></span>
                                                    </span>
                                                </label>
                                                @endforeach
                                            </div>
                                    ...
                                    <div class="col-sm-10">
                                        <div class="product-quantity d-flex align-items-center">
                                            <div class="row no-gutters align-items-center aiz-plus-minus mr-3" style="width: 130px;">
                                                <button class="btn col-auto btn-icon btn-sm btn-circle btn-primary text-white" type="button" data-type="minus" data-field="quantity" disabled="">
                                                ...
                                                <button class="btn col-auto btn-icon btn-sm btn-circle btn-primary text-white" type="button" data-type="plus" data-field="quantity">
                            ...
                            <div class="mt-3">
                                ...
                                @else
                                    <button type="button" class="btn text-white btn-primary buy-now fw-600 rounded-pill" onclick="addToCart()">
                                        <i class="las la-shopping-bag"></i>
                                        <span class="d-inline-block"> {{ translate('Add to cart')}}</span>
                                    </button>
                                    <button type="button" class="btn btn-primary buy-now fw-600 rounded-pill ml-2" onclick="buyNow()">
                                        <i class="la la-shopping-cart"></i> {{ translate('Buy Now')}}
                                    </button>
                                @endif
                                <button type="button" class="btn btn-secondary out-of-stock fw-600 d-none rounded-pill" disabled>
                ...
                <div class="col-xl-9 order-0 order-xl-1">
                    <div class="bg-white mb-3 shadow-sm rounded">
                        <div class="nav border-bottom aiz-nav-tabs">
                            <a href="#tab_default_1" data-toggle="tab" class="p-3 fs-16 fw-600 text-reset show">{{ translate('Description')}}</a>

...
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'admin']], function() {
    ...
    Route::controller(ProductController::class)->group(function () {
        ...
        Route::get('/products/destroy/{product}', 'destroy')->name('products.destroy');
    ...
    Route::group(['prefix' => 'website'], function() {
        ...
        Route::group(['as'=>'website.'], function() {
            ...
            Route::get('/faq/destroy/{faq}', [FaqController::class,'destroy'])->name('faq.destroy');
        });
        // Custom Page
    ...
    Route::controller(PreOrderController::class)->group(function () {
        Route::get('pre_order/', 'admin_index')->name('pre_order.admin_index');
        // Route::get('support_ticket/{id}/show', 'admin_show')->name('support_ticket.admin_show');
        // Route::post('support_ticket/reply', 'admin_store')->name('support_ticket.admin_store');
    });

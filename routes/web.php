...
Route::controller(HomeController::class)->group(function () {
    ...
    Route::post('/home/section/auction_products',
        'load_auction_products_section')->name('home.section.auction_products');
...
Route::group(['middleware' => ['user', 'verified', 'unbanned']], function () {
    ...
    Route::controller(HomeController::class)->group(function () {
        Route::get('/dashboard', 'dashboard')->name('dashboard')->middleware('customer');
...
Route::group(['middleware' => ['customer', 'verified', 'unbanned']], function () {
    ...
    // Customer Package
    Route::post('/customer_packages/purchase',
    ...
    // Product Review
    Route::post('/product_review_modal',
...
Route::controller(PayhereController::class)->group(function () {
    ...
    Route::any('/payhere/seller_package_payment/notify',
        'seller_package_notify')->name('payhere.seller_package_payment.notify');
    Route::any('/payhere/seller_package_payment/return',
        'seller_package_payment_return')->name('payhere.seller_package_payment.return');
    Route::any('/payhere/seller_package_payment/cancel',
        'seller_package_payment_cancel')->name('payhere.seller_package_payment.cancel');
...
Route::controller(PageController::class)->group(function () {
    //mobile app bank page for webview
